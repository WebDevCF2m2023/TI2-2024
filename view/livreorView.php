        ...
        <div class="myFormDiv">
            <form action="" id="myForm" method="post" onsubmit="validateInputs()">
                ...
                <div class="messageDiv">
                    ...
                    <textarea name="message"  id="yourMessageInput" cols="30" rows="10" maxlength="999"></textarea>
            ...
            if (isset($pagination)) echo "<p>$pagination</p>";  
                foreach ($showMessages as $showMess) : ?>
                    <div class="messageHolder">
                        <h4><span class="italic"><?=$showMess["firstname"]?></span> à envoyé ce message le <?=$showMess["datemessage"] ?></h4>
                        <p><?= wordwrap($showMess["message"], 28, "\n", true) ?></p>
                    </div>
                    <?php
                    endforeach;
            ?>
